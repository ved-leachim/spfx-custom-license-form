...
export default class GraphHttpClient {
     ...
     * @internal
     */
    fetch<T>(url: string, configuration: GraphHttpClientConfiguration, options: IGraphHttpClientOptions, cacheConfiguration: IRequestCacheOptions): Promise<IClientCachableResponse<T, GraphHttpClientResponse>>;
    /**
     * Perform a REST service call.
     *
     * @remarks
     ...
     * @internal
     */
    fetch<T>(url: string, configuration: GraphHttpClientConfiguration, options: IGraphHttpClientOptions, cacheConfiguration: IHttpRequestCacheOptions): Promise<T | GraphHttpClientResponse>;
    /**
     ...
     * @internal
     */
    get<T>(url: string, configuration: GraphHttpClientConfiguration, options: IGraphHttpClientOptions | undefined, cacheConfiguration: IRequestCacheOptions): Promise<IClientCachableResponse<T, GraphHttpClientResponse>>;
    /**
     * Calls fetch(), but sets the method to "GET".
     * @param url - the URL to fetch
     * @param configuration - determines the default behavior of GraphHttpClient; normally this should
     ...
     * @internal
     */
    get<T>(url: string, configuration: GraphHttpClientConfiguration, options: IGraphHttpClientOptions | undefined, cacheConfiguration: IHttpRequestCacheOptions): Promise<T | GraphHttpClientResponse>;
    /**
