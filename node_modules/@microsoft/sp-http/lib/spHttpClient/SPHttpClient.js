...
import { _getCacheDataProviderServiceKey } from '..';
/**
...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype.get = function (url, configuration, options, cacheConfiguration) {
        if (cacheConfiguration) {
            return this.fetch(url, configuration, SPHttpClientHelper.overrideHttpMethod(options, 'GET'), cacheConfiguration);
        }
        else {
