import { Validate, _SPKillSwitch } from '@microsoft/sp-core-library';
...
var AadHttpClient = /** @class */ (function () {
    ...
    AadHttpClient.prototype.fetch = function (url, configuration, options) {
        ...
        return this._fetch(url, configuration, options, this._useCachedToken).then(function (originalResponse) {
            if (!_SPKillSwitch.isActivated('0cf10fc5-9dba-4929-9644-68aa50693e25'
    ...
    AadHttpClient.prototype._fetch = function (url, configuration, options, useCachedToken) {
        ...
        return tokenFetchPromise.then(function (token) {
            ...
            if (!_SPKillSwitch.isActivated('784afa03-cdaa-4a5a-84a0-479d431cc639'
            ...
            return HttpClientHelper.fetchCore(configuration, new Request(url, options), _this._serviceScope, _this._fetchProvider, AadHttpClient._className).then(function (response) {
                if (!_SPKillSwitch.isActivated('0e4428bc-190b-4f77-9ed8-93de78c314db'
                /* '07/10/20', 'Calculate time in milliseconds of token fetch request' */
                )) {
                    return new AadHttpClientResponse(response, endTimer - startTimer);
                }
                else {
