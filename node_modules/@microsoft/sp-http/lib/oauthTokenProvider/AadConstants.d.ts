...
export default class AadConstants {
     ...
     */
    static readonly UNRESOLVABLE_AAD_ERROR_CODES: Set<string>;
    /**
     * Set of error codes that can be resolved by a full page redirect to Azure AD.
     * {@link https://docs.microsoft.com/en-us/azure/active-directory/develop/reference-aadsts-error-codes}
     */
    static readonly RESOLVABLE_AAD_ERROR_CODES: Set<string>;
    /**
     * Set of error codes that we mark as expected.
     * {@link https://docs.microsoft.com/en-us/azure/active-directory/develop/reference-aadsts-error-codes}
     */
    static readonly EXPECTED_AAD_ERRORS: Set<string>;
    /**
     * Error code from AAD for login required.
     * {@link https://docs.microsoft.com/en-us/azure/active-directory/develop/reference-aadsts-error-codes}
     */
    static readonly LOGIN_REQUIRED: string;
    /**
     * Error code from AAD for timeout
     */
    static readonly TOKEN_RENEWAL_TIMEOUT: string;
    /**
     * Error code from AAD for network error
     */
    static readonly ENDPOINTS_RESOLUTION_ERROR: string;
    /**
     * Set of error codes that can be resolved by a full page redirect to Azure AD.
     ...
     */
    static readonly OFFICE_365_SHAREPOINT_ONLINE_ID: string;
    /**
     * This string contains the link to SPO third party app Identifier Uri
     */
    static readonly SPO_THIRD_PARTY_APP_IDENTIFIER_URI: string;
}
