import { OAuthTokenType } from '@ms/sp-client-shared';
...
export default class OAuthTokenProvider {
     ...
     * @internal
     */
    getOAuthToken(resource: string, webUrl: string, tokenType: OAuthTokenType): Promise<any>;
    /**
