    ...
    isNavData, cachedEntry) {
        if (cachedEntry && cachedEntry.item) {
            ...
            if (entry.item) {
                ...
                if (!_SPKillSwitch.isActivated('5433a3bc-803a-458b-b88b-2ae6540f7d43'
