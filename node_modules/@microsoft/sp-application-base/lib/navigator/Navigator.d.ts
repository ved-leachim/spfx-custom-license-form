...
/**
 * Exposes a private method to only be used by the framework.
 *
 * @internal
 */
export interface IPrivateNavigator {
    _setPreloadedData(data: _IPreloadedData): void;
}
/**
...
export default class Navigator {
     ...
     */
    get preloadedData(): _IPreloadedData;
    /**
     ...
     */
    invalidate(url: string | RegExp): Promise<void>;
