...
var NavigationDataProvider = /** @class */ (function () {
    ...
    NavigationDataProvider.prototype._getStore = function () {
        ...
        return (this._navigationStorePromise ||
            (this._navigationStorePromise = import('./NavigationDataStore' /* webpackChunkName: 'sp-navigation-datastore' */).then(function (dataStore) {
    ...
    NavigationDataProvider.prototype._fetchData = function (url, requestHeaders) {
        ...
        return this._spHttpClient
            .get(url + (url.indexOf('?') === -1 ? '?' : '&') + 'as=json', SPHttpClient.configurations.v1, requestHeaders ? { headers: requestHeaders } : undefined)
