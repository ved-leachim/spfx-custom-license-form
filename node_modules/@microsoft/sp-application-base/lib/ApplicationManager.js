...
import { Environment, EnvironmentType, Guid, Text, Validate, _SPEventManager } from '@microsoft/sp-core-library';
...
import * as strings from './SPApplicationBase.resx';
// Qos constants
...
var ApplicationManager = /** @class */ (function () {
    ...
    ApplicationManager.prototype.startApplication = function (preloadedData, pageChrome) {
        ...
        if (!this._isChromelessApplication(applicationId) && !pageChrome) {
            pageChrome = new SPPageChrome(this._serviceScope, undefined, applicationId);
        }
        var appManifest = SPComponentLoader.tryGetManifestById(applicationId);
        var appComponent = !!appManifest
            ? SPComponentLoader.tryGetLoadedComponent(appManifest)
            : undefined;
        if (appComponent) {
    ...
    ApplicationManager.prototype._loadApplicationComponent = function (applicationId, error) {
        return SPComponentLoader.loadComponentById(applicationId).catch(function (e) {
