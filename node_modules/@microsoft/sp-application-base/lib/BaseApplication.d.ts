...
export default class BaseApplication extends BaseComponent {
    ...
    private readonly _onSecondFlushEvent;
    private _secondFlushPreloadedData;
    private _secondFlushEventRaised;
    private _loadedDuringFirstFlush;
    constructor();
    /**
     ...
     * @virtual
     */
    protected onBeforeLoad(): Promise<void>;
    /**
     ...
     * to invoke public APIs
     */
    protected _invalidate(url: string | RegExp): Promise<void>;
    /**
     * Raises an event for a layout change.
     */
    protected raiseLayoutChangedEvent(): void;
    private _handleSecondFlush;
