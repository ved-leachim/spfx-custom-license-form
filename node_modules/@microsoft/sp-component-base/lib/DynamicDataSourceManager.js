...
var DynamicDataSourceManager = /** @class */ (function () {
    ...
    DynamicDataSourceManager.prototype._getPropertyValue = function (propertyId) {
        ...
        try {
            ...
            qosMonitor.writeSuccess(__assign(__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, propertyValue: propertyValue,
    ...
    DynamicDataSourceManager.prototype._getAnnotatedPropertyValue = function (propertyId) {
        ...
        if (getAnnotatedPropertyValue) {
            ...
            try {
                ...
                qosMonitor.writeSuccess(__assign(__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, annotatedPropertyValue: annotatedPropertyValue,
                    propertyId: propertyId }));
            }
            catch (error) {
