...
var PropertyPaneController = /** @class */ (function () {
    ...
    PropertyPaneController.prototype._showPropertyPane = function () {
        ...
        this._propertyPaneContainer.classList.add(this._narrowRender ? styles.showPaneNarrow : styles.showPane);
    ...
    PropertyPaneController.prototype._hidePropertyPane = function () {
        ...
        this._propertyPaneContainer.classList.remove(this._narrowRender ? styles.showPaneNarrow : styles.showPane);
