...
var DynamicDataWidgetEntry = /** @class */ (function (_super) {
    ...
    DynamicDataWidgetEntry.prototype._getDropdownForSubProperty = function (level, propertyPath, selectedKey) {
        ...
        if (level === 0 && !KillSwitches.isSubPropertyLabelOverrideKillSwitchActivated()) {
            this._parentSelectedKey = selectedKey || this._selectedSubPropertyText;
        }
        var labelTxt = KillSwitches.isSubPropertyLabelOverrideKillSwitchActivated() && level === 0
            ? Text.format(Strings.DynamicDataPropertiesDropdownLabel, selectedText)
            : selectedText;
