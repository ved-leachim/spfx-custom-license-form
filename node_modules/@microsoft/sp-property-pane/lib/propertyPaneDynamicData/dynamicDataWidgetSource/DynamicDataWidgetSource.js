...
import { autobind, Label, Link } from '@microsoft/office-ui-fabric-react-bundle';
...
var DynamicDataWidgetSource = /** @class */ (function (_super) {
    ...
    DynamicDataWidgetSource.prototype._renderSourceDropdown = function () {
        ...
        return (React.createElement("div", null, !sourceIdFilter && (React.createElement("div", null,
            ...
            showErrorMessage && (React.createElement(Link, { href: 'https://go.microsoft.com/fwlink/?linkid=2117174', target: '_blank' }, strings.LearnMoreLable))))));
    };
    /**
