...
import { Guid, Text, _SPKillSwitch } from '@microsoft/sp-core-library';
...
import * as strings from './ExtensionStrings.resx';
/**
...
var ExtensionManager = /** @class */ (function () {
    ...
    ExtensionManager._isRemoveExtensionInstanceCheckKSActivated = function () {
        return _SPKillSwitch.isActivated('18b43a9e-2334-47a7-9ac3-9606271defd8'
    ...
    ExtensionManager.prototype.createExtension = function (componentId, propertiesJson, contextCreator) {
        ...
        try {
            ...
            var createPromise = SPComponentLoader.loadComponent(manifest)
            ...
            var fabricLoadingPromise = _LegacyThirdPartyFabricCoreLoader.forceLoad(manifest);
            fabricLoadingPromise.catch(function (e) {
                return _TraceLogger.logError(ExtensionManager._logSource, new Error("Failed to load legacy fabric core styles: " + e));
            });
