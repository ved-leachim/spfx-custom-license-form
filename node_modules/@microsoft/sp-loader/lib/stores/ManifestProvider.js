import { Validate, Session, _SPFlight } from '@microsoft/sp-core-library';
...
var ManifestProvider = /** @class */ (function () {
    ...
    ManifestProvider.prototype.tryGetManifests = function (ids) {
        ...
        return this._httpClient
            .post(webUrl + ManifestProvider._restApiUrl, SPHttpClient.configurations.v1, _SPFlight.isEnabled(436 /* SppplatUseDeploymentPools */)
            ? {
                body: JSON.stringify({
                    components: ids,
