...
import { loadScriptWithoutEval } from './loadScriptWithoutEval';
...
var RequireJsLoader = /** @class */ (function () {
    ...
    RequireJsLoader.prototype.load = function (manifest, name, globalName) {
        return this.requireLoad(normalizeName(manifest, name), globalName) /* tslint:disable-line:no-any */
    ...
    RequireJsLoader.prototype._resolveAddress = function (manifest, resourceName) {
        var address = resolveAddress(manifest, resourceName, this.useSecondaryCdn);
