...
import * as strings from './Error.resx';
...
var SPLoaderError = /** @class */ (function (_super) {
    ...
    function SPLoaderError(errorCode, innerError, isExpected) {
        ...
        var _this = _super.call(this, SPLoaderErrorCode[errorCode], Text.format.apply(Text, __spreadArrays([SPLoaderError._errorCodeToMessageMap.get(errorCode)], params))) || this;
