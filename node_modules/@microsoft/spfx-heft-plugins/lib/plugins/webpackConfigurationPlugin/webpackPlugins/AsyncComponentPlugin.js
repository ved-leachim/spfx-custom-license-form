...
exports.AsyncComponentPlugin = void 0;
            ...
            compilation.hooks.optimizeChunkModules.tap(PLUGIN_NAME, (baseChunks, baseModules) => {
                ...
                for (const module of modules) {
                    ...
                    if (externalComponent) {
                        componentModuleCache.set(externalComponent.componentId, Object.assign(Object.assign({}, externalComponent), { module: module }));
                        ...
                        for (const chunkComponentId of chunkComponentIds) {
                            if (!runtimeChunkComponentIds.has(chunkComponentId)) {
                                ...
                                if (!componentVariables.has(chunkComponent.componentId)) {
                                    componentVariables.set(chunkComponent.componentId, Object.assign(Object.assign({}, chunkComponent), { variableName: `component_${chunkVariableCounter++}` }));
                                }
                            }
                        }
