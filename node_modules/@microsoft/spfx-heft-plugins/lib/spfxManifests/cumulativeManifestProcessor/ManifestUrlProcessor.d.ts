...
export declare class ManifestUrlProcessor {
    /**
     ...
     */
    static processInternalModuleBaseUrls(manifest: IClientSideComponentManifest, relativePath: string, baseUrl: string): void;
}
//# sourceMappingURL=ManifestUrlProcessor.d.ts.map