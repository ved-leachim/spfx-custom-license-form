...
class Rush {
    ...
    static _printStartupBanner(isManaged) {
        ...
        console.log(os_1.EOL +
            colors_1.default.bold(`Rush Multi-Project Build Tool ${Rush.version}` + colors_1.default.yellow(isManaged ? '' : ' (unmanaged)')) +
            colors_1.default.cyan(` - ${RushConstants_1.RushConstants.rushWebSiteUrl}`) +
            os_1.EOL +
