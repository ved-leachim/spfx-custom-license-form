...
class DeployManager {
    ...
    async _prepareDeploymentAsync(deployState) {
        ...
        for (const projectName of includedProjectNamesSet) {
            console.log(colors_1.default.cyan('Analyzing project: ') + projectName);
    ...
    async deployAsync(mainProjectName, scenarioName, overwriteExisting, targetFolderParameter, createArchiveFilePath) {
        ...
        console.log(colors_1.default.cyan('Deploying to target folder:  ') + targetRootFolder);
        console.log(colors_1.default.cyan('Main project for deployment: ') + mainProjectName + '\n');
        ...
        console.log('\n' + colors_1.default.green('The operation completed successfully.'));
    }
}
