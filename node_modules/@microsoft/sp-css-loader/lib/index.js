...
async function processCssAsync(content, resourcePath) {
    ...
    const processor = getPostcssProcessor(options.generateCssClassName);
    let result;
    try {
...
function getPostcssProcessor(generateCssClassName) {
            ...
            plugins = [
                ...
                postcss_modules_scope_1.default({
                    generateScopedName: (existingClassName, cssFilePath, cssContent) => {
                        return generateCssClassName(existingClassName, cssFilePath, cssContent);
                    }
                }),
                ...POST_MODULE_PLUGINS
            ];
