...
export default class PropertyPaneAccessor {
    ...
    constructor(openProperytPane: () => void, closePropertyPane: () => void, refresh: () => void, openDetails: (context?: any) => void, // tslint:disable-line:no-any
    isRenderedByWebPart: () => boolean, isPropertyPaneOpen: () => boolean);
    /**
