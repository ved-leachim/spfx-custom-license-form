 ...
 * @internal
 */
export declare const enum CacheStatus {
    True = "true",
    False = "false",
    NotAvailable = "N/A"
}
...
export default interface IWebPartLoadData {
    ...
    renderTime?: number;
    /**
     * Synchronous time taken by render function first execution.
     */
    ...
    /**
     * List of comma separated experiment and flight ids with status on and off.
