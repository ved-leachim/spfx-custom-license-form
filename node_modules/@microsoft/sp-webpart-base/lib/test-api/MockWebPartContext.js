...
import { WebPartContext, WebPartFormFactor } from '../index'; // <-- part of "test-api" pattern; see sp-build-internal-web/includes/test-api-pattern/README.md
...
var MockWebPartContextParameters = /** @class */ (function () {
    function MockWebPartContextParameters() {
        ...
        this.statusRenderer = {};
        this.host = {};
        this.formFactor = WebPartFormFactor.Standard;
        this.propertyPane = {
            open: function () {
                /* no-op */
            },
...
var MockWebPartContext = /** @class */ (function (_super) {
    __extends(MockWebPartContext, _super);
