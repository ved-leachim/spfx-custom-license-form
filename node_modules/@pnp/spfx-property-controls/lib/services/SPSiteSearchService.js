...
var SPSiteSearchService = /** @class */ (function () {
    ...
    SPSiteSearchService.prototype.searchSites = function (ctx, query) {
        if (Environment.type === EnvironmentType.Local) {
            ...
            var userRequestUrl = ctx.pageContext.web.absoluteUrl + "/_api/search/query?querytext='contentclass:STS_Site contentclass:STS_Web Title:" + query + "* Path:" + rootUrl + "*'&selectproperties='SiteId,SiteID,WebId,Title,Path'&rowlimit=5";
