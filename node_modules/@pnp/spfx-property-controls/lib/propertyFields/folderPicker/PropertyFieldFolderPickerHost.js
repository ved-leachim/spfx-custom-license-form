...
var PropertyFieldFolderPickerHost = /** @class */ (function (_super) {
    ...
    function PropertyFieldFolderPickerHost(props) {
        ...
        _this._onFolderSave = function () {
            ...
            setPropertyValue(_this.props.properties, _this.props.targetProperty, _this._selectedFolder);
        ...
        _this.state = {
            showPanel: false,
            selectedFolder: getPropertyValue(props.properties, props.targetProperty) || _this.props.defaultFolder
        };
        return _this;
    }
    PropertyFieldFolderPickerHost.prototype.componentWillReceiveProps = function (nextProps) {
        var currentValue = getPropertyValue(this.props.properties, this.props.targetProperty);
        var nextValue = getPropertyValue(nextProps.properties, nextProps.targetProperty);
...
export default PropertyFieldFolderPickerHost;
