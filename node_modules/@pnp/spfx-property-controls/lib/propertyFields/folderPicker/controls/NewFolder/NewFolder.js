...
var NewFolder = /** @class */ (function (_super) {
    ...
    NewFolder.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.libraryItem },
            ...
            this.state.showInput &&
                React.createElement(TextField, { placeholder: strings.NewFolderNamePlaceholder, value: this.state.folderName, onChange: function (e, value) { return _this._onFolderNameChange(value); } }),
