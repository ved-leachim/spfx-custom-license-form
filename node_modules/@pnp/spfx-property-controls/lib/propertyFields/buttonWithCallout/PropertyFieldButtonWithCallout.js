...
var PropertyFieldButtonWithCalloutBuilder = /** @class */ (function () {
    ...
    PropertyFieldButtonWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldButtonHost, __assign(__assign({}, omit(props, ['icon', 'buttonType'])), { buttonType: buttonType }));
...
export function PropertyFieldButtonWithCallout(targetProperty, properties) {
    return new PropertyFieldButtonWithCalloutBuilder(targetProperty, __assign(__assign({}, properties), { onRender: null, onDispose: null }));
}
