    ...
    function PropertyPanePropertyEditorHost(props, state) {
        ...
        _this.onSave = function () {
            ...
            for (var propName in newProperties) {
                ...
                var currentValue = getPropertyValue(_this.props.webpart.properties, propName);
                if (currentValue) {
                    if (currentValue.__type === "DynamicProperty") {
                        var currVal = currentValue;
                        var newVal = newProperties[propName];
                        ...
                        setPropertyValue(_this.props.webpart.properties, propName, newProperties[propName]);
                    }
            ...
            _this.setState(function (current) { return (__assign(__assign({}, current), { openPanel: false })); });
        };
        /**
         * Called when the properties editor changes
         */
        _this.onChange = function (newValue, event) {
            _this.setState(function (current) { return (__assign(__assign({}, current), { propertiesJson: newValue })); });
        };
        /**
        ...
        _this.onOpenPanel = function () {
            ...
            _this.setState(function (current) { return (__assign(__assign({}, current), { propertiesJson: _this.previousValue })); });
            _this.cancel = true;
            _this.setState({
                openPanel: true,
            });
        ...
        _this.onUpload = function () {
            if (_this.fileRef.files.length > 0 && _this.fileRef.files[0].type === "application/json") {
                ...
                fileReader_1.onload = function () {
                    ...
                    _this.setState(function (current) { return (__assign(__assign({}, current), { propertiesJson: jsonString })); });
                };
            }
            else {
