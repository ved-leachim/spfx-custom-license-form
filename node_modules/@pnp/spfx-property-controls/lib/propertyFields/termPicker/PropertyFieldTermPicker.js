 ...
 * @internal
 */
var PropertyFieldTermPickerBuilder = /** @class */ (function () {
    /**
     * Constructor method
     */
    ...
    PropertyFieldTermPickerBuilder.prototype.render = function (elem, ctx, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldTermPickerHost, {
            label: this.label,
...
export { PropertyFieldTermPickerBuilder };
/**
...
export function PropertyFieldTermPicker(targetProperty, properties) {
    ...
    return new PropertyFieldTermPickerBuilder(targetProperty, __assign(__assign({}, properties), { targetProperty: targetProperty, onRender: null, onDispose: null, termService: new SPTermStorePickerService(properties, properties.context) }));
}
