...
export function PropertyFieldEnterpriseTermPicker(targetProperty, properties) {
    ...
    return new PropertyFieldTermPickerBuilder(targetProperty, __assign(__assign({}, termPickerInternalProps), { targetProperty: targetProperty, onRender: null, onDispose: null, termService: new PnPTermStorePickerService(properties, properties.context) }));
}
