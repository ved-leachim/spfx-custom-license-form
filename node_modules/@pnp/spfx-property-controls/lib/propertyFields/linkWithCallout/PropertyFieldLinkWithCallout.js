 ...
 */
var PropertyFieldLinkWithCalloutBuilder = /** @class */ (function () {
    ...
    PropertyFieldLinkWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldLinkHost, __assign({}, props));
...
export function PropertyFieldLinkWithCallout(targetProperty, properties) {
    return new PropertyFieldLinkWithCalloutBuilder(targetProperty, __assign(__assign({}, properties), { onRender: null, onDispose: null }));
}
