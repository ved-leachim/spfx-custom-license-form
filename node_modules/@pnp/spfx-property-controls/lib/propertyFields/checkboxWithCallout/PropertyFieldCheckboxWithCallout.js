 ...
 */
var PropertyFieldCheckboxWithCalloutBuilder = /** @class */ (function () {
    ...
    PropertyFieldCheckboxWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldCheckboxHost, __assign(__assign({}, props), { onChange: this._onChange.bind(this) }));
...
export function PropertyFieldCheckboxWithCallout(targetProperty, properties) {
    return new PropertyFieldCheckboxWithCalloutBuilder(targetProperty, __assign(__assign({}, properties), { onRender: null, onDispose: null }));
}
