 ...
 */
var PropertyFieldLabelWithCalloutBuilder = /** @class */ (function () {
    ...
    PropertyFieldLabelWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldLabelHost, __assign({}, props));
...
export function PropertyFieldLabelWithCallout(targetProperty, properties) {
    return new PropertyFieldLabelWithCalloutBuilder(targetProperty, __assign(__assign({}, properties), { onRender: null, onDispose: null }));
}
