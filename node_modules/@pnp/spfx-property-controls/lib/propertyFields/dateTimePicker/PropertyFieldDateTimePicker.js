...
var PropertyFieldDateTimePickerBuilder = /** @class */ (function () {
    ...
    PropertyFieldDateTimePickerBuilder.prototype.render = function (elem, ctx, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldDateTimePickerHost, {
            label: this.label,
...
export function PropertyFieldDateTimePicker(targetProperty, properties) {
    ...
    return new PropertyFieldDateTimePickerBuilder(targetProperty, __assign(__assign({}, properties), { targetProperty: targetProperty, onDispose: null, onRender: null }));
}
