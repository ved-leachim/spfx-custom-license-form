...
var PropertyFieldPasswordBuilder = /** @class */ (function () {
    ...
    PropertyFieldPasswordBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldPasswordHost, __assign(__assign({}, props), { onChanged: this._onChanged.bind(this) }));
...
export function PropertyFieldPassword(targetProperty, properties) {
    return new PropertyFieldPasswordBuilder(targetProperty, __assign(__assign({}, properties), { onChanged: properties.onChanged, onRender: null, onDispose: null }));
}
