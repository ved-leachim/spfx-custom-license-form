...
var PropertyFieldDropdownWithCalloutBuilder = /** @class */ (function () {
    ...
    PropertyFieldDropdownWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldDropdownHost, __assign(__assign({}, omit(props, ['options', 'ariaPositionInSet', 'ariaSetSize'])), { options: props.options || [], onChanged: this._onChanged.bind(this) }));
...
export function PropertyFieldDropdownWithCallout(targetProperty, properties) {
    return new PropertyFieldDropdownWithCalloutBuilder(targetProperty, __assign(__assign({}, properties), { onRender: null, onDispose: null }));
}
